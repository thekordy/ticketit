...
namespace Kordy\Ticketit\Http\Routes;
 ...
 *
 * @package  Kordy\Ticketit\Http\Routes
 * @author   Kiko Seijo <kikopc@gmail.com>
 *
 * @codeCoverageIgnore
 */
class TicketitRoute extends RouteRegistrar
{
    /* ------------------------------------------------------------------------------------------------
     |  Main Functions
     | ------------------------------------------------------------------------------------------------
    ...
    public function map()
    {
        $this->name('ticketit::')->group(function () {
            // ticketit::dashboard
