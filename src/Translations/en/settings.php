...
return [
	...
	'main_route' => '<p><b>Ticketit main route</b>: Where to load the ticket system (ex. <code>http://url/tickets</code>)</p>'

	,'admin_route' => '<p><b>Ticketit admin route</b>: Where to load the ticket administration dashboard (ex. <code>http://url/tickets-admin</code>)</p>'

	,'master_template' => '<p><b>Template adherence</b>: The master blade template to be extended</p>'

	,'email.template' => '<p><b>Template adherence</b>: The email blade template to be extended</p>'
	...
	,'email.google_plus_link' => '<p><b>Toogle icon link</b>: empty or string</p><p><img src="http://i.imgur.com/fzyxfSg.jpg"/></p>'
	,'email.facebook_link' => '<p><b>Toogle icon link</b>: empty or string</p><p><img src="http://i.imgur.com/FQQzr98.jpg"/></p>'
	,'email.twitter_link' => '<p><b>Toogle icon link</b>: empty or string</p><p><img src="http://i.imgur.com/5JmkrF1.jpg"/></p>'
	,'email.footer' => ''
	,'email.footer_link' => ''
	...
	,'default_status_id' => '<p>The default status for new created tickets</p>'

	,'default_close_status_id' => '<p>The default closing status</p>'

	,'default_reopen_status_id' => '<p>The default reopening status</p>'

	,'paginate_items' => '<p><b>Pagination length</b>: For standard pagination.</p>'

	,'length_menu' => '<p><b>Pagination length</b>: For tickets table</p>'
...
ENDHTML
	...
	,'close_ticket_perm' => '<p><b>Close Ticket Perm</b>: Who has a permission to close tickets</p>'

	,'reopen_ticket_perm' => '<p><b>Reopen Ticket Perm</b>: Who has a permission to reopen tickets</p>'


	,'delete_modal_type' => <<<ENDHTML
