...
return [
  ...
  */
  ...
  'table-category'                   => 'Kategória',
   ...
   // Bootgrid
  'bootgrid-infos'                   => '{{ctx.start}} - {{ctx.end}} sorok megjelenítve. Összesen: {{ctx.total}} sor',
  'bootgrid-loading'                 => 'Töltés...',
  'bootgrid-noResults'               => 'Nincs találat!',
  'bootgrid-refresh'                 => 'Frissítés',
  'bootgrid-search'                  => 'Keresés',
