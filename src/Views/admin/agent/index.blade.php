...
@section('page')
    {{ trans('ticketit::admin.agent_index_title') }}
@stop
...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2>{{ trans('ticketit::admin.agent_index_title') }}
                {!! link_to_route(
        ...
        @if ($agents->isEmpty())
            <h3 class="text-center">{{ trans('ticketit::admin.agent_index_no_agents') }}
                {!! link_to_route(config('ticketit.admin_route').'.agent.create', trans('ticketit::admin.agent_index_create_new')) !!}
            </h3>
        @else
            <div id="message"></div>
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <td>{{ trans('ticketit::admin.table-remove_agent') }}</td>																											
                    </tr>
                </thead>
                <tbody>
