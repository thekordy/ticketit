...
$router->group(['middleware' => 'auth'], function () use ($main_route) {
    //Ticket public route
...
$router->group(['middleware' => 'Kordy\Ticketit\Middleware\IsAgentMiddleware'], function () use ($main_route) {
...
$router->group(['middleware' => 'Kordy\Ticketit\Middleware\IsAdminMiddleware'], function () use ($admin_route) {
